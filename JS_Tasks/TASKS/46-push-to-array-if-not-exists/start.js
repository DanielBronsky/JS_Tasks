...
const pushIfUnique = (inputArray, newEllement) => {
  if (inputArray.includes(newEllement)) {
    return console.log(`${newEllement} уже находится в массиве`);
  }

  inputArray.push(newEllement);
};
